...
const InfoSection = ({ lightBg, id, imgStart, topLine, lightText, headline, darkText, description, buttonLabel, img, alt, primary, dark, dark2 }) => {
  return (
    <div id="aboutpage" className="relative font-encode-sans-expanded bg-gray-900 py-16 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0 items-center justify-center">
        {/* Card 1 */}
        <div className="bg-white shadow-md p-6 flex flex-col items-center rounded-lg transform transition-transform duration-300 hover:scale-105 relative hover:shadow-[0_-10px_15px_-3px_rgb(34,197,94),0_10px_15px_-3px_rgb(34,197,94)] w-full md:w-1/4">
          {/* Logo */}
